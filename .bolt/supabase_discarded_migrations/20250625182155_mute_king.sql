/*
  # Create comprehensive achievements system

  1. New Tables
    - Clear and recreate achievements with comprehensive set
    - Add all achievement categories and types
    - Include proper difficulty levels and point values

  2. Features
    - 40+ unique achievements covering all aspects of running
    - Distance, speed, consistency, elevation, weather, and social achievements
    - Progressive difficulty levels with appropriate point rewards
    - Special milestone and seasonal achievements

  3. Security
    - All tables have proper RLS policies
    - Achievement data is read-only for users
    - User achievements require authentication
*/
...
-- Distance Achievements (Progressive)
...
-- Speed Achievements (Progressive)
